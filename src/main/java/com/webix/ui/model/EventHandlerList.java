    ...
    implements java.io.Serializable
{
     ...
     * Field events.
     */
    private java.util.List<EventHandler> events;
     ...
     * @return List
     */
    public java.util.List<EventHandler> getEvents()
    {
        if ( this.events == null )
        {
            this.events = new java.util.ArrayList<EventHandler>();
        }

        return this.events;
    } //-- java.util.List<EventHandler> getEvents()
     ...
     * @param events
     */
    public void setEvents( java.util.List<EventHandler> events )
    {
        this.events = events;
    } //-- void setEvents( java.util.List )
