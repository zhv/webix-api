    ...
    implements java.io.Serializable
{
     ...
     * Field colors.
     */
    private java.util.List<org.w3c.dom.css.RGBColor> colors;
     ...
     * @return List
     */
    public java.util.List<org.w3c.dom.css.RGBColor> getColors()
    {
        if ( this.colors == null )
        {
            this.colors = new java.util.ArrayList<org.w3c.dom.css.RGBColor>();
        }

        return this.colors;
    } //-- java.util.List<org.w3c.dom.css.RGBColor> getColors()
     ...
     * @param colors
     */
    public void setColors( java.util.List<org.w3c.dom.css.RGBColor> colors )
    {
        this.colors = colors;
    } //-- void setColors( java.util.List )
